...
3. Crear un programa que lea por teclado una cadena y un carácter, y reemplace todos los espacios por el carácter. Ej: mi archivo de texto.txt y _ debería devolver mi_archivo_de_texto.txt
...
7. Crea un programa que lea una cadena de caracteres y muestre la siguiente información:
...
10. Escribir un programa que dado una palabra diga si es un palíndromo. Un palídromo Un palíndromo es una palabra, número o frase que se lee igual hacia adelante que hacia atrás. Ejemplo: reconocer

11. Crea un programa para que compruebe si una frase es palíndroma. Ejemplo: Yo hago yoga hoy
*/
